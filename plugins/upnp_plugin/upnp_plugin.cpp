...
static UpnpConnector *g_upnpConnector;
...
extern "C" DLL_PUBLIC MPMResult pluginCreate(MPMPluginCtx **plugin_specific_ctx)
{
    ...
    *plugin_specific_ctx = ctx;
    ...
    g_upnpConnector = new UpnpConnector(NULL, NULL);
