...
static const std::string UPNP_OIC_URI_PREFIX_LIGHT                  = "/upnp/oic/light/";
static const std::string UPNP_OIC_URI_PREFIX_BRIGHTNESS             = "/upnp/oic/brightness/";
static const std::string UPNP_OIC_URI_PREFIX_POWER_SWITCH           = "/upnp/oic/switch/";
static const std::string UPNP_OIC_URI_PREFIX_INET_GATEWAY           = "/upnp/oic/igd/";
static const std::string UPNP_OIC_URI_PREFIX_LAYER3_FORWARDING      = "/upnp/oic/l3f/";
static const std::string UPNP_OIC_URI_PREFIX_DEVICE_PROTECTION      = "/upnp/oic/device-protection/";
static const std::string UPNP_OIC_URI_PREFIX_WAN                    = "/upnp/oic/wan/";
static const std::string UPNP_OIC_URI_PREFIX_WAN_IF_CONFIG          = "/upnp/oic/wan/ifconfig/";
static const std::string UPNP_OIC_URI_PREFIX_WAN_CABLE_LINK_CONFIG  = "/upnp/oic/wan/cableconfig";
static const std::string UPNP_OIC_URI_PREFIX_WAN_DSL_LINK_CONFIG    = "/upnp/oic/wan/dslconfig";
static const std::string UPNP_OIC_URI_PREFIX_WAN_ETHERNET_CONFIG    = "/upnp/oic/wan/ethernetconfig";
static const std::string UPNP_OIC_URI_PREFIX_WAN_POTS_LINK_CONFIG   = "/upnp/oic/wan/potsconfig";
static const std::string UPNP_OIC_URI_PREFIX_WAN_CONNECTION         = "/upnp/oic/wan/connection";
static const std::string UPNP_OIC_URI_PREFIX_WAN_IP_CONNECTION      = "/upnp/oic/wan/ip";
static const std::string UPNP_OIC_URI_PREFIX_WAN_PPP_CONNECTION     = "/upnp/oic/wan/ppp";
static const std::string UPNP_OIC_URI_PREFIX_LAN                    = "/upnp/oic/lan";
static const std::string UPNP_OIC_URI_PREFIX_LAN_HOST_CONFIG        = "/upnp/oic/lan/hostconfig";
static const std::string UPNP_OIC_URI_PREFIX_MEDIA_RENDERER         = "/upnp/oic/media/renderer/";
static const std::string UPNP_OIC_URI_PREFIX_MEDIA_SERVER           = "/upnp/oic/media/server/";
static const std::string UPNP_OIC_URI_PREFIX_CONNECTION_MANAGER     = "/upnp/oic/connection-manager/";
static const std::string UPNP_OIC_URI_PREFIX_AV_TRANSPORT           = "/upnp/oic/av-transport/";
static const std::string UPNP_OIC_URI_PREFIX_CONTENT_DIRECTORY      = "/upnp/oic/content-directory/";
static const std::string UPNP_OIC_URI_PREFIX_RENDERING_CONTROL      = "/upnp/oic/rendering-control/";
static const std::string UPNP_OIC_URI_PREFIX_SCHEDULED_RECORDING    = "/upnp/oic/scheduled-recording/";
