...
static const std::string UPNP_OIC_TYPE_CONNECTION_MANAGER               =
    "oic.r.connection.manager";
...
static const std::string UPNP_OIC_TYPE_SCHEDULED_RECORDING              =
    "oic.r.scheduled.recording";
static const std::string UPNP_OIC_TYPE_WAN_IF_CONFIG                    =
    "oic.r.wan.interface.config";
...
static const std::string UPNP_OIC_URI_PREFIX_WAN_ETHERNET_CONFIG        =
    "/oic/upnp/wan/ethernetconfig";
static const std::string UPNP_OIC_URI_PREFIX_WAN_CONNECTION             =
    "/oic/upnp/wan/connection";
static const std::string UPNP_OIC_URI_PREFIX_LAN                        = "/oic/upnp/lan";
static const std::string UPNP_OIC_URI_PREFIX_LAN_HOST_CONFIG            =
    "/oic/upnp/lan/hostconfig";
static const std::string UPNP_OIC_URI_PREFIX_MEDIA_RENDERER             =
    "/oic/upnp/media/renderer/";
static const std::string UPNP_OIC_URI_PREFIX_MEDIA_SERVER               = "/oic/upnp/media/server/";
static const std::string UPNP_OIC_URI_PREFIX_CONNECTION_MANAGER         =
    "/oic/upnp/connection-manager/";
static const std::string UPNP_OIC_URI_PREFIX_AV_TRANSPORT               = "/oic/upnp/av-transport/";
static const std::string UPNP_OIC_URI_PREFIX_CONTENT_DIRECTORY          =
    "/oic/upnp/content-directory/";
static const std::string UPNP_OIC_URI_PREFIX_RENDERING_CONTROL          =
    "/oic/upnp/rendering-control/";
static const std::string UPNP_OIC_URI_PREFIX_SCHEDULED_RECORDING        =
    "/oic/upnp/scheduled-recording/";
