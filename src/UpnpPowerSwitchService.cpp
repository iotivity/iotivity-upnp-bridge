...
// Actions:
//    0: "GET" action name (can be NULL), action type, optional out parameters: var_name,var_type
//    0: "SET" action name (can be NULL), action type, optional in parameters: var_name,var_type
