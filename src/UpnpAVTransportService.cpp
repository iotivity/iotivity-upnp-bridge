...
void UpnpAVTransport::getTargetCb(GUPnPServiceProxy *proxy,
...
GUPnPServiceProxyAction* UpnpAVTransport::getTarget(UpnpRequest *request)
{
...
void UpnpAVTransport::setTargetCb(GUPnPServiceProxy *proxy,
                                  GUPnPServiceProxyAction *action,
                                  gpointer userData)
{
    GError *error = NULL;
...
GUPnPServiceProxyAction * UpnpAVTransport::setTarget(RCSResourceAttributes::Value& attrValue, UpnpRequest *request)
{
