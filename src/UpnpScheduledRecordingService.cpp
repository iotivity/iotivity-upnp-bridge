...
void UpnpScheduledRecording::getTargetCb(GUPnPServiceProxy *proxy,
...
GUPnPServiceProxyAction* UpnpScheduledRecording::getTarget(UpnpRequest *request)
{
...
void UpnpScheduledRecording::setTargetCb(GUPnPServiceProxy *proxy,
                                  GUPnPServiceProxyAction *action,
                                  gpointer userData)
{
    GError *error = NULL;
...
GUPnPServiceProxyAction * UpnpScheduledRecording::setTarget(RCSResourceAttributes::Value& attrValue, UpnpRequest *request)
{
