...
void UpnpRenderingControl::getTargetCb(GUPnPServiceProxy *proxy,
...
GUPnPServiceProxyAction* UpnpRenderingControl::getTarget(UpnpRequest *request)
{
...
void UpnpRenderingControl::setTargetCb(GUPnPServiceProxy *proxy,
                                  GUPnPServiceProxyAction *action,
                                  gpointer userData)
{
    GError *error = NULL;
...
GUPnPServiceProxyAction * UpnpRenderingControl::setTarget(RCSResourceAttributes::Value& attrValue, UpnpRequest *request)
{
