...
static const std::string UPNP_PATTERN_DEVICE_MEDIA_RENDERER  = UPNP_PREFIX_DEVICE + ":.*(?:[Mm][Ee][Dd][Ii][Aa][Rr][Ee][Nn][Dd][Ee][Rr][Ee][Rr]).*";
static const std::string UPNP_PATTERN_DEVICE_MEDIA_SERVER  = UPNP_PREFIX_DEVICE + ":.*(?:[Mm][Ee][Dd][Ii][Aa][Ss][Ee][Rr][Vv][Ee][Rr]).*";
