...
void UpnpContentDirectory::getTargetCb(GUPnPServiceProxy *proxy,
...
GUPnPServiceProxyAction* UpnpContentDirectory::getTarget(UpnpRequest *request)
{
...
void UpnpContentDirectory::setTargetCb(GUPnPServiceProxy *proxy,
                                  GUPnPServiceProxyAction *action,
                                  gpointer userData)
{
    GError *error = NULL;
...
GUPnPServiceProxyAction * UpnpContentDirectory::setTarget(RCSResourceAttributes::Value& attrValue, UpnpRequest *request)
{
