...
class UpnpWanCableLinkConfig: public UpnpService
{
        friend class UpnpService;

    public:
        typedef bool (UpnpWanCableLinkConfig::*GetAttributeHandler)(UpnpRequest *);

        UpnpWanCableLinkConfig(GUPnPServiceInfo *serviceInfo,
                               UpnpRequestState *requestState):
            UpnpService(serviceInfo, UPNP_OIC_TYPE_WAN_CABLE_LINK_CONFIG, requestState, &Attributes)
        {
        }
