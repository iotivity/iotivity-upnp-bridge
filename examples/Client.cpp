...
void listResources() {
    ...
    cout << "\t" << s_lightLookup.size() <<" lights" << endl;
    cout << "\t" << s_gatewayDeviceLookup.size() << " Gateways Devices" << endl; //TODO add gateway device
    cout << "\n\tTotal resources " << s_lightLookup.size() + s_gatewayDeviceLookup.size() << endl;
    cout << "-----------------------------" << endl;
}
