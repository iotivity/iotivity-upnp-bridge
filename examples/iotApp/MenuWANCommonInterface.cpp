...
void MenuWANCommonInterface::print()
{
    ...
    cout << "setefi) setefi <#> <true/false> - enable or disable access to and from the Internet" <<
         endl;
        ...
        else if ("setefi" == cmd[0])
        {
            if (cmd.size() > 2)
            {
                try
                {
                    ...
                    {
                    		cout << "The internet enabled flag must be 'true' or 'false'." << endl;
                    		return;
                    }
