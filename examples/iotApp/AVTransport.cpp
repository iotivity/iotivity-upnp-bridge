...
void AVTransport::setAVTransportURI(unsigned int instanceId, std::string currentURI, std::string currentUriMetadata)
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_setAVTransportURICb = bind(&AVTransport::onSetAVTransportURI, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
...
void AVTransport::onSetAVTransportURI(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
void AVTransport::setNextAVTransportURI(unsigned int instanceId, std::string nextUri, std::string nextUriMetadata)
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_setNextAVTransportURICb = bind(&AVTransport::onSetNextAVTranportURI, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
            {"nextUri", nextUri},
...
void AVTransport::onSetNextAVTranportURI(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
AVTransport::MediaInfo AVTransport::getMediaInfo(unsigned int instanceId)
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_mediaInfo = {"", "", "", "", "", "", "", "", 0};
    m_getMediaInfoCb = bind(&AVTransport::onGetMediaInfo, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
    };
...
void AVTransport::onGetMediaInfo(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
...
AVTransport::TransportInfo AVTransport::getTransportInfo(unsigned int instanceId)
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_transportInfo = {"", "", ""};
    m_getTransportInfoCb = bind(&AVTransport::onGetTransportInfo, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
    };
...
void AVTransport::onGetTransportInfo(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
...
AVTransport::PositionInfo AVTransport::getPositionInfo(unsigned int instanceId)
{
    ...
    m_getPositionInfoCb = bind(&AVTransport::onGetPositionInfo, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
    };
...
void AVTransport::onGetPositionInfo(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
...
AVTransport::DeviceCapabilities AVTransport::getDeviceCapabilities(unsigned int instanceId)
{
    ...
    m_getDeviceCapabilitiesCb = bind(&AVTransport::onGetDeviceCapabilities, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
    };
...
void AVTransport::onGetDeviceCapabilities(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
...
AVTransport::TransportSettings AVTransport::getTransportSettings(unsigned int instanceId)
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_transportSettings = {"", ""};
    m_getTransportSettingsCb = bind(&AVTransport::onGetTransportSettings, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
    };
...
void AVTransport::onGetTransportSettings(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_stopCb = bind(&AVTransport::onStop, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)}
    };
...
void AVTransport::onStop(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_playCb = bind(&AVTransport::onPlay, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
            {"speed", speed}
    };
...
void AVTransport::onPlay(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_pauseCb = bind(&AVTransport::onPause, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)}
    };
...
void AVTransport::onPause(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_seekCb = bind(&AVTransport::onSeek, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
            {"unit", unit},
            {"target", target}
...
void AVTransport::onSeek(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_nextCb = bind(&AVTransport::onNext, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)}
    };
...
void AVTransport::onNext(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_previouseCb = bind(&AVTransport::onPrevious, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)}
    };
...
void AVTransport::onPrevious(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_setPlayModeCb = bind(&AVTransport::onSetPlayMode, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)},
...
void AVTransport::onSetPlayMode(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
{
    std::unique_lock<std::mutex> avTranportLock(m_mutex);
    m_getCurrentTransportActionsCb = bind(&AVTransport::onGetCurrentTransportActions, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    OC::QueryParamsMap param = {
            {"instanceId", std::to_string(instanceId)}
    };
...
void AVTransport::onGetCurrentTransportActions(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
