...
#ifndef MENUAVTRANSPORT_H_
#define MENUAVTRANSPORT_H_
...
class MenuAVTransport: public MenuBase
{
    public:
        MenuAVTransport();
        virtual ~MenuAVTransport();
        /*
    ...
    private:
        ...
        std::set<OC::OCResource::Ptr, OCResourceComp> m_avTransportSet;
        std::vector<OC::OCResource::Ptr> m_avTransportVector;
        bool m_quit;
        std::mutex m_mutex;
