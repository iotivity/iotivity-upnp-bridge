...
void MenuRenderingControl::print()
{
    ...
    std::cout << "getmute) getmute <#> <instanceId> <channel> - get mute" << std::endl;
    std::cout << "setmute) setmute <#> <instanceId> <channel> <desiredMute> - set mute" << std::endl;
    std::cout << "getvol) getvol <#> <instanceId> <channel> - get volume" << std::endl;
    std::cout << "setvol) setvol <#> <instanceId> <channel> <desiredMute> - set volume" << std::endl;
