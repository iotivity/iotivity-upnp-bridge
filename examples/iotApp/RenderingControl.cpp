...
void RenderingControl::onListPresets(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
...
void RenderingControl::onSelectPresets(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
void RenderingControl::onGetMute(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
    ...
    OC::QueryParamsMap param =
        {
            {"instanceId", std::to_string(instanceId)},
            {"channel", channel},
            {"desiredMute", std::to_string(desiredMute)}
        };
    m_resource->get(param, m_getMuteCb);
    m_cv.wait(renderingControlLock);
}

void RenderingControl::onSetMute(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
...
void RenderingControl::onGetVolume(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    if (eCode == OC_STACK_OK)
    {
...
void RenderingControl::setVolume(unsigned int instanceId, std::string channel, unsigned int desiredVolume)
{
    std::unique_lock<std::mutex> renderingControlLock(m_mutex);
...
void RenderingControl::onSetVolume(const OC::HeaderOptions &headerOptions, const OC::OCRepresentation &rep, const int eCode)
{
    (void) headerOptions;
    (void) rep;
    (void) eCode;
