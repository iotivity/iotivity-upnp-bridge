...
#ifndef MENUWANCOMMONINTERFACE_H_
#define MENUWANCOMMONINTERFACE_H_
...
class MenuWANCommonInterface: public MenuBase
{
    public:
        MenuWANCommonInterface();
        virtual ~MenuWANCommonInterface();
        /*
    ...
    private:
        ...
        std::set<OC::OCResource::Ptr, OCResourceComp> m_wanCommonInterfaceSet;
        std::vector<OC::OCResource::Ptr> m_wanCommonInterfaceVector;
        bool m_quit;
        std::mutex m_mutex;
...
#endif /* MENUWANCOMMONINTERFACE_H_ */
